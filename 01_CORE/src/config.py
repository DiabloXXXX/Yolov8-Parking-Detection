...
class Config:
    ...
    def load_default_config(self):
        ...
        self.MODEL_PATH = self.get_absolute_path('03_MODELS/yolov8s.pt')
        self.CLASS_LIST_PATH = self.get_absolute_path('04_DATA/parking_area/class_list.txt')
        ...
        self.VIDEO_PATHS = [
            self.get_absolute_path('04_DATA/parking_area/video/park1.mp4'),
            self.get_absolute_path('04_DATA/parking_area/video/park2.mp4'), 
            self.get_absolute_path('04_DATA/parking_area/video/park3.mp4'),
            self.get_absolute_path('04_DATA/parking_area/video/park4.mp4')
        ]
        ...
        self.OUTPUT_DIR = self.get_absolute_path('08_LOGS_OUTPUT/output')
        ...
        self.DEFAULT_TEST_POINTS = {
            'park1.mp4': [(0, 0), (1920, 0), (1920, 1080), (0, 1080)],
            'park2.mp4': [(0, 0), (1920, 0), (1920, 1080), (0, 1080)],
            'park3.mp4': [(0, 0), (1920, 0), (1920, 1080), (0, 1080)],
            'park4.mp4': [(0, 0), (1920, 0), (1920, 1080), (0, 1080)]
        }
